// ponytail: 306-line god-hook tied to ModuleGraph exemption; remove
...
import type {
  ...
  TimelapseAction,
  ZoomCommandKind,
} from "../components/GraphSettingsPanel";
import { applyGraphFilters, maxEffectiveEdgeScore } from "../components/graphSelectors";
import { useGraphLayoutStore } from "../components/useGraphLayoutStore";
import { useGraphSettings } from "../components/useGraphSettings";
import { CHART_CATEGORY_COLORS } from "./graphUiHelpers";
